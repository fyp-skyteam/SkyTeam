...
public class UploadManager {
	...
	//private HashMap<String,ArrayList<String>> studentErrors = new HashMap<String,ArrayList<String>>();
	//private HashMap<String,ArrayList<String>> bookingErrors = new HashMap<String,ArrayList<String>>();
	...
	public ArrayList<String> readCSV(ZipInputStream zin) {
		...
		try {
			int count = 0;
			while ((aLocation = in.readLine()) != null) {
				count++;
				if (count > 1) {
					output.add(aLocation);
				}
			}
		} catch (Exception e) {
	...
	public ArrayList<Location> convertDataToLocations(ArrayList<String> locationData, String datasetName, int datasetNumber, String currency){
		...
		for(int i=0;i<locationData.size();i++){
			...
			String longitudeStr = data[1].trim();
                        ...
                        if(locationErrorStr.isEmpty()){
                            ...
                            //int datasetNumber = Integer.parseInt(datasetNumberStr);
		...
		/**if(claim.isEmpty()){
			return false;
		}else if(invalidDoubleStr(latitude)){
                        return false;
                }*/
